...
namespace NumeralToWord
{
    /// <summary>
    /// the author of this class is unkown.
    /// </summary>
    public class numeraltoword
    {
        ...
        private Regex r;
        private string _decimales, _decimales02;
        ...
        public string decimales02
        {
            set { _decimales02 = value; }

            get { return _decimales02; }

        }

        public String Convert(String number, bool isupper, bool typedatatime)
        {
            ...
            MatchCollection mc = r.Matches(number);
            if (mc.Count > 0)
            {
